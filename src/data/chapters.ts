...
export const chapters: Chapter[] = [
  {
    ...
    flashcards: [
      ...
      { id: 5, front: "The print() shortcut!", back: "For more complex messages, use an f-string. Just add an f before the first quote and put your variables in {}. It's way easier.\n\nExample:\nprint(f\"Your score is {score}!\")", flipped: false },
      ...
      { id: 23, front: "What is the output of this code?\n\nhp = 100\nprint(f\"Current HP: {hp}\")", back: "Current HP: 100", flipped: false },
