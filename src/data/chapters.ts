...
export const chapters: Chapter[] = [
  {
    ...
    description: "Learn to make your computer talk and store game data like a pro developer",
    difficulty: "Beginner",
    unlocked: true,
    completed: false,
    flashcards: [
      { id: 1, front: "print()", back: "Your command to make the computer \"talk.\" It's like typing something in a game's chat box or a dialogue popping up on screen.\n\nExample:\nprint(\"You found a hidden key!\")", flipped: false },
      { id: 2, front: "What goes in print()?", back: "Anything you want to display! Text needs quotes, but numbers don't.\n\nExample:\nprint(\"Hello!\")\nprint(100)", flipped: false },
      { id: 3, front: "What is a string?", back: "A string is just text, words, or letters. Think of a character's name or a quest log entry. They're always wrapped in quotes.\n\nExample:\n\"Knight\" or \"Defeat the dragon\"", flipped: false },
      { id: 4, front: "What happens here?\nprint(\"Score:\", 500)", back: "The computer shows Score: 500. It prints both the text and the number on the same line, separated by a comma.", flipped: false },
      { id: 5, front: "How do you join strings together?", back: "Use the + operator to concatenate (join) strings together. You can combine text with text, but numbers need to be converted to strings first.\n\nExample:\nname = \"Hero\"\nprint(\"Welcome \" + name + \"!\")", flipped: false },
      { id: 6, front: "What is a variable?", back: "A named container that stores a value. It's like an inventory slot where you can put a sword, an apple, or a number of coins.\n\nExample:\ncoins = 100", flipped: false },
      { id: 7, front: "How do you create a variable?", back: "Give it a name, then use the = sign to assign a value.\n\nExample:\nplayer_name = \"Shadow_Warrior\"", flipped: false },
      { id: 8, front: "How do you name a variable?", back: "Stick to letters, numbers, and underscores (_). It can't start with a number.\n\nmy_level works, but 3rd_level doesn't!", flipped: false },
      { id: 9, front: "How do you change a variable's value?", back: "Just assign it a new value. You can change your health after taking damage or your score after earning points.\n\nExample:\nhealth = 100\nhealth = 75", flipped: false },
      { id: 10, front: "What is the final value of x?\n\nx = 10\nx = 20\nx = 30", back: "30. Python always uses the most recent value assigned to the variable.", flipped: false },
      { id: 11, front: "How do you print what's inside a variable?", back: "Use the variable's name inside print() without quotes. If you use quotes, Python will print the name itself, not the value.\n\nExample:\nloot = \"Gold Chest\"\nprint(loot)", flipped: false },
      { id: 12, front: "What is the output?\n\ncoins = 100\nprint(\"coins\")", back: "coins (The word itself, not the number)", flipped: false },
      { id: 13, front: "What are the two main data types we've used?", back: "Strings (text in quotes) and Integers (whole numbers without quotes).", flipped: false },
      { id: 14, front: "What is the data type for a player's score?", back: "An integer (int). It's a whole number, like 100 or 50.", flipped: false },
      { id: 15, front: "What is the data type for a player's username?", back: "A string (str). It's a series of text characters.", flipped: false },
      { id: 16, front: "Can you do math with variables?", back: "Yes! You can add, subtract, multiply, and divide them just like normal numbers.\n\nExample:\ntotal_xp = xp_from_quest + xp_from_mob", flipped: false },
      { id: 17, front: "What is the output of print(10 + 5)?", back: "15. Python does the math for you first.", flipped: false },
      { id: 18, front: "What is the output?\n\ngold_found = 20\ngold_spent = 5\ntotal_gold = gold_found - gold_spent\nprint(total_gold)", back: "15. It calculates the final value and prints it.", flipped: false },
      { id: 19, front: "What's the output?\n\nusername = \"NoobSlayer\"\nlevel = 20\nprint(username, \"is now level\", level)", back: "NoobSlayer is now level 20", flipped: false },
      { id: 20, front: "What is a comment?", back: "A line of code that Python ignores. It starts with a # and is used to write notes to yourself or other people.\n\nExample:\n# This code calculates damage", flipped: false },
      { id: 21, front: "What's a good way to start a program?", back: "With a welcome message!\n\nExample:\nprint(\"Welcome to Python Adventure!\")", flipped: false },
      { id: 22, front: "How do you make a blank line in your output?", back: "Just use an empty print statement!\n\nExample:\nprint()", flipped: false },
      { id: 23, front: "How do you convert a number to text?", back: "Use the str() function to convert numbers to strings so you can concatenate them.\n\nExample:\nhp = 100\nprint(\"Current HP: \" + str(hp))", flipped: false },
      { id: 24, front: "Challenge: Create two variables, sword_damage and shield_defense, then print the total power.", back: "sword_damage = 25\nshield_defense = 10\ntotal_power = sword_damage + shield_defense\nprint(f\"Total power is: {total_power}\")", flipped: false },
      { id: 25, front: "What is the final output of this mini-program?\n\nprint(\"Starting game...\")\nplayer_name = \"Hero\"\nprint(\"Welcome, \" + player_name + \"!\")\nprint(\"Good luck on your quest.\")", back: "Starting game...\nWelcome, Hero!\nGood luck on your quest.", flipped: false }
    ],
    questions: [
      { id: 1, question: "In a game script, you want to display the number of gems a player has collected. Which line of code will correctly show this information, assuming gems_collected is a variable holding the number?", options: ["print(\"gems_collected\")", "print(gems_collected)", "print('You have ' + gems_collected)", "print(gems_collected, ' gems')"], correctAnswer: 1, answered: false },
      { id: 2, question: "What will be the output of the following code snippet?\n\nplayer_level = 5\nplayer_level = 10\nprint(player_level)", options: ["5", "10", "5\\n10", "player_level"], correctAnswer: 1, answered: false },
      { id: 3, question: "You have a variable named hero_class. Which of the following is an example of storing text in this variable?", options: ["hero_class = 15", "hero_class = Warrior", "hero_class = 'Warrior'", "'hero_class' = Warrior"], correctAnswer: 2, answered: false },
      { id: 4, question: "Which of the following is a valid name for a Python variable?", options: ["2nd_place", "gold-coins", "player_health", "for"], correctAnswer: 2, answered: false },
      { id: 5, question: "Using the comma separator in the print() function has a specific behavior. What is that behavior?", options: ["It adds a new line between the items", "It combines the items with no spaces", "It causes a syntax error", "It automatically adds a space between the items being printed"], correctAnswer: 3, answered: false },
      { id: 6, question: "You want to print the total points from a quest. You have two variables: base_xp = 50 and bonus_xp = 10. Which line of code will print the sum?", options: ["print('base_xp + bonus_xp')", "print(base_xp + bonus_xp)", "print(base_xp, '+', bonus_xp)", "print(total_xp)"], correctAnswer: 1, answered: false },
      { id: 7, question: "Which of the following is the best way to print the message \"You lost 50 hit points.\" where the number 50 is stored in a variable damage?", options: ["print(\"You lost\", damage, \"hit points.\")", "print(\"You lost \" + str(damage) + \" hit points.\")", "print(\"You lost {damage} hit points.\")", "print(\"You lost\" + damage + \"hit points.\")"], correctAnswer: 1, answered: false },
      { id: 8, question: "What is the purpose of adding a # at the beginning of a line of code?", options: ["It creates an error that stops the program", "It turns the line into a mathematical equation", "It tells Python to ignore the rest of the line", "It stores the line as a variable"], correctAnswer: 2, answered: false },
      { id: 9, question: "Which of these statements correctly explains the difference between an integer and a string?", options: ["An integer can be used in math, while a string is only used for text", "An integer is a variable, and a string is a command", "An integer is always in quotes, and a string is never in quotes", "You can perform math on both integers and strings"], correctAnswer: 0, answered: false },
      { id: 10, question: "What will be the final output of the following code?\n\nplayer_level = 5\nprint('Level:', player_level)\nplayer_level = player_level + 1\nprint('New Level:', player_level)", options: ["Level: 5\\nNew Level: 5", "Level: 5\\nNew Level: 6", "New Level: 6", "Level: 5\\nNew Level: 7"], correctAnswer: 1, answered: false }
    ]
  },
  {
    id: 2,
