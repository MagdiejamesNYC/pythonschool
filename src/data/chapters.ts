...
export const chapters: Chapter[] = [
  {
    ...
    completed: false,
    flashcards: [
      { id: 1, front: "What is a variable in Python?", back: "A variable is like a labeled box where you store information so the computer can remember it.", flipped: false },
      { id: 2, front: "Why do we use variables?", back: "So we can save values (like names, scores, or answers) and use them later in our code.", flipped: false },
      { id: 3, front: "What kind of things can a variable hold?", back: "Words, numbers, lists, and even True or False answers!", flipped: false },
      { id: 4, front: "Can you name a variable anything?", back: "Almost! It must start with a letter or underscore, no spaces, and can't be a Python keyword (like if or print).", flipped: false },
      { id: 5, front: "What's cool about variables?", back: "You can change their value anytime—just like changing what's inside a box!", flipped: false },
      { id: 6, front: "How do you create a variable called age with the value 10?", back: "age = 10", flipped: false },
      { id: 7, front: "Can variable names have spaces?", back: "No! Use underscores like this: my_age = 10", flipped: false },
      { id: 8, front: "What symbol do we use to assign a value to a variable?", back: "The = sign.", flipped: false },
      { id: 9, front: "Can variable names start with a number?", back: "No. Variable names must start with a letter or an underscore.", flipped: false },
      { id: 10, front: "What will this print?\nname = \"Alex\"\nprint(name)", back: "It will print: Alex", flipped: false },
      { id: 11, front: "What's the difference between = and ==?", back: "= sets a value, == checks if two things are equal.", flipped: false },
      { id: 12, front: "Can you change a variable's value later?", back: "Yes! Variables can change. That's why they're called \"variables\".", flipped: false },
      { id: 13, front: "What type of value is this: \"Hello\"?", back: "A string (text)", flipped: false },
      { id: 14, front: "What type of value is this: 25?", back: "An integer (a whole number)", flipped: false },
      { id: 15, front: "What will this code do?\nscore = 5\nscore = score + 1\nprint(score)", back: "It will print: 6", flipped: false },
      { id: 16, front: "Can you store a math answer in a variable?", back: "Yes! Example: total = 3 + 4", flipped: false },
      { id: 17, front: "What does this print?\na = 3\nb = 2\nprint(a * b)", back: "It prints 6", flipped: false },
      { id: 18, front: "What will this print?\nword = \"cat\"\nprint(word + \"fish\")", back: "It prints catfish", flipped: false },
      { id: 19, front: "Can variables store user input?", back: "Yes! Example: name = input(\"What's your name? \")", flipped: false },
      { id: 20, front: "What is the type of 3.14 in Python?", back: "A float (a number with a decimal)", flipped: false },
      { id: 21, front: "Can a variable store a True/False value?", back: "Yes! That's called a Boolean.", flipped: false },
      { id: 22, front: "What will this code print?\nhappy = True\nprint(happy)", back: "It prints True", flipped: false },
      { id: 23, front: "What is the type of this variable?\nitems = [\"apple\", \"banana\", \"cherry\"]", back: "A list (a collection of items)", flipped: false },
      { id: 24, front: "Can you use variables inside print messages?", back: "Yes! Example:\nname = \"Ben\"\nprint(\"Hello, \" + name)", flipped: false },
      { id: 25, front: "What happens if you try to use a variable that's not defined?", back: "You get an error: NameError", flipped: false },
      { id: 26, front: "Can a variable name be just one letter?", back: "Yes! Like x = 5", flipped: false },
      { id: 27, front: "What does this code do?\nx = 10\nx += 5\nprint(x)", back: "It prints 15", flipped: false },
      { id: 28, front: "What does len() do with a variable?", back: "It tells how many characters are in a string (or how many items in a list)", flipped: false },
      { id: 29, front: "Can you use more than one variable in a print?", back: "Yes! Example:\nname = \"Lily\"\nage = 11\nprint(name, \"is\", age, \"years old\")", flipped: false },
      { id: 30, front: "What will this print?\nmy_list = [1, 2, 3]\nprint(my_list[0])", back: "It prints 1 (the first item)", flipped: false },
      { id: 31, front: "What does this do?\na = 4\nb = 2\na, b = b, a", back: "It swaps the values! Now a is 2 and b is 4.", flipped: false },
      { id: 32, front: "What is a constant variable?", back: "A variable that doesn't change. (We write it in ALL CAPS by convention)", flipped: false },
      { id: 33, front: "What does type() do?", back: "It tells you what kind of value a variable has.", flipped: false },
      { id: 34, front: "What is a good rule for naming variables?", back: "Use clear names like player_score, not short ones like ps.", flipped: false },
      { id: 35, front: "What are Python's main data types?", back: "int (whole numbers), float (decimals), str (text), bool (True/False), list (collections)", flipped: false }
    ],
    questions: [
      { id: 1, question: "Which is a valid variable name?", options: ["2name", "_name", "name-2", "class"], correctAnswer: 1, answered: false },
      { id: 2, question: "What symbol assigns a value to a variable?", options: ["==", "=", ":", "->"], correctAnswer: 1, answered: false },
      { id: 3, question: "What type is 3.14?", options: ["int", "float", "str", "bool"], correctAnswer: 1, answered: false },
      { id: 4, question: "What type is \"Hello\"?", options: ["int", "float", "str", "bool"], correctAnswer: 2, answered: false },
      { id: 5, question: "What type is True?", options: ["int", "float", "str", "bool"], correctAnswer: 3, answered: false },
      { id: 6, question: "Can variable names have spaces?", options: ["Yes", "No", "Sometimes", "Only with quotes"], correctAnswer: 1, answered: false },
      { id: 7, question: "What does this print? x = 10; x += 5; print(x)", options: ["10", "15", "5", "Error"], correctAnswer: 1, answered: false },
      { id: 8, question: "What does len('hello') return?", options: ["4", "5", "Error", "'hello'"], correctAnswer: 1, answered: false },
      { id: 9, question: "What happens if you use an undefined variable?", options: ["Returns None", "Returns 0", "NameError", "Creates it"], correctAnswer: 2, answered: false },
      { id: 10, question: "What does this print? word = 'cat'; print(word + 'fish')", options: ["cat fish", "catfish", "Error", "cat+fish"], correctAnswer: 1, answered: false },
      { id: 11, question: "What does type() function do?", options: ["Changes type", "Shows variable type", "Creates variable", "Deletes variable"], correctAnswer: 1, answered: false },
      { id: 12, question: "Can you change a variable's value?", options: ["Yes", "No", "Only once", "Only numbers"], correctAnswer: 0, answered: false },
      { id: 13, question: "What's the difference between = and ==?", options: ["No difference", "= assigns, == compares", "= compares, == assigns", "Both assign"], correctAnswer: 1, answered: false },
      { id: 14, question: "What does this do? a=4; b=2; a,b = b,a", options: ["Error", "Swaps values", "Adds values", "Nothing"], correctAnswer: 1, answered: false },
      { id: 15, question: "What's a good variable naming practice?", options: ["Short names like 'x'", "Clear names like 'player_score'", "Numbers first", "All caps"], correctAnswer: 1, answered: false }
    ]
  },
  {
    id: 2,
